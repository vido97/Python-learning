    ...
    while True:
        ...
        try:
            ...
            while row > max_row or row < 1 or column > max_column or column < 1:
                ...
                print("A row coordinate has to be between 1 and {:d}, and a column coordinate "
                      "between 1 and {:d}.".format(max_row, max_column))
                print("Enter the coordinates of the box separated by comma (row,column):")
                coord_string = input()
                parts = coord_string.split(",")
                row = int(parts[0])
...
def main():
    ...
    while not game.is_ended():
        ...
        if point_earned:
            if game.is_ended():
                print("{:s} earned a point.".format(player))
            else:
                print("{:s} earned a point and takes another turn.".format(player))
    ...
    if winner == DotsAndBoxesGame.TIE:
        ...
        print("The winner is {:s}!".format(winner))
    print()
    print("Program ends.")
